...
contract LendingPoolCore is VersionedInitializable {
    ...
    **/
    // modifies(addressesProvider, lendingPoolAddress)
    function initialize(LendingPoolAddressesProvider _addressesProvider) public initializer {
        addressesProvider = _addressesProvider;
        // modify(lendingPoolAddress)
    ...
    **/
    // modifies(reserves[_reserve], usersReserveData[_user][_reserve].useAsCollateral)
    function updateStateOnDeposit(
        ...
        if (_isFirstDeposit) {
            ...
            // modify(usersReserveData[_user][_reserve].useAsCollateral)
    ...
    **/
    // modifies(reserves[_reserve], usersReserveData[_user][_reserve])
    function updateStateOnBorrow(
        ...
        // modify(usersReserveData[_user][_reserve])
    ...
    **/
    // modifies(reserves[_principalReserve], reserves[_collateralReserve], usersReserveData[_user][_principalReserve])
    function updateStateOnLiquidation(
        ...
        // modify(reserves[_principalReserve])
        ...
        // modify(reserves[_collateralReserve])
        updateCollateralReserveStateOnLiquidationInternal(
            _collateralReserve
        );

        // modify(usersReserveData[_user][_principalReserve])
...
function updateStateOnLiquidation(...) external onlyLendingPool {
    // modify(reserves[_principalReserve])
    updatePrincipalReserveStateOnLiquidationInternal(...);
    ...
    **/
    // modifies(usersReserveData[_user][_reserve].useAsCollateral)
    ...
    **/
    // modifies(reservesList, reserves[_reserve])
    ...
    **/
    // modifies(reserves[_reserveToRemove], reservesList)
    ...
    **/
    // modifies(reserves[_reserve].interestRateStrategyAddress)
    ...
    * @param _reserve the address of the reserve
    **/
    // modifies(reserves[_reserve].isStableBorrowRateEnabled)
    ...
    * @param _reserve the address of the reserve
    **/
    // modifies(reserves[_reserve].isActive)
    ...
    * @param _reserve the address of the reserve
    **/
    // modifies(reserves[_reserve].isFreezed)
    ...
    **/
    // modifies(reserves[_reserve].baseLTVasCollateral)
    ...
    **/
    // modifies(reserves[_reserve].liquidationThreshold)
    ...
    **/
    // modifies(reserves[_reserve].liquidationBonus)
    ...
    **/
    // modifies(reserves[_reserve].decimals)
    ...
    **/
    ...
    // modifies(usersReserveData[_user][_reserve])
    ...
    * @param _balanceIncrease the accrued interest on the borrowed amount
    **/
    // modifies(reserves[_principalReserve])
    ...
    * @param _collateralReserve the address of the collateral reserve that is being liquidated
    **/
    // modifies(reserves[_collateralReserve])
